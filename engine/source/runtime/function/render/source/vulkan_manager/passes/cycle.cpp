...
#include <cycle_frag.h>
#include <post_process_vert.h>

namespace Pilot
{
    void PCyclePass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PCyclePass::setupDescriptorSetLayout()
    {
    ...
    void PCyclePass::setupPipelines()
    {
        std::printf("setupPipelines pCycle");
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, CYCLE_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_cycle;
    ...
    void PCyclePass::setupDescriptorSet()
    {
    ...
    void PCyclePass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PCyclePass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Cycle", {1.0f, 1.0f, 1.0f, 1.0f}};
